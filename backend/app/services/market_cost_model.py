...
# EtcOptions를 요청 payload에 넣으면 API가 이미 옵션을 좁혀주므로 30페이지 스캔은 과합니다.
# 5개 장신구 x 2단계(±5/±10) x 5페이지 = 최대 50회로 분당 제한 100회 안에 둡니다.
...
def _basic_listing_matches(row: dict[str, Any], item: EquipmentItem, quality_tolerance: int) -> bool:
